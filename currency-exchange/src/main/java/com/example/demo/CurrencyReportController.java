...
public class CurrencyReportController {
    ...
    public CurrencyReport retrieveExchangeValue(@PathVariable String from,
            @PathVariable String to) {
        logger.info("retrieveExchangeValue called with from {} to {}", from,
                to);
        CurrencyReport currencyExchange = repository.findByFromAndTo(from,
                to);
